<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\admin\edit.html";i:1569664097;s:74:"C:\phpStudy\PHPTutorial\WWW\work\application\admin\view\public\static.html";i:1568445051;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <a class="button border-yellow" href=""><span class="icon-plus-square-o"></span> 修改密码</a>
    </div>
    ...
    <div class="body-content">
        <form method="post" class="form-x" id="form-x" action="">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="oldpassword" value=""  />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
