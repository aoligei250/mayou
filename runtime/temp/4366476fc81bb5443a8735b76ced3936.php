<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\admingroup\index.html";i:1572272072;s:74:"C:\phpStudy\PHPTutorial\WWW\work\application\admin\view\public\static.html";i:1568445051;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <tr>
            ...
            <td>
                <div class="button-group">
                    <a type="button"  class="button border-main" href="<?php echo url('admin/admingroup/edit',['id'=>$val['id']]); ?>"><span class="icon-edit"></span>修改</a>
...
<script>
    function del(obj,id){
        layer.confirm("您确定要删除吗",{icon:3,title:"提示"},function () {
            //  alert(id);
            $.get("<?php echo url('admin/admin/del'); ?>",{id:id},function (data) {
                if(data==1)
                {
            ...
            <div class="form-group">
                ...
                <div class="field">
                  ...
                  echo str_repeat("|---",$val['level']); ?>
                        <input     type="checkbox" class="checkbox-parent <?php if($val['level'] != 0): ?> checkbox-child <?php endif; ?>" name="rules[]" value="<?php echo $val['id']; ?>"  >
...
<script>
    function save() {
       ...
       // alert(data);
        $.ajax({
            'url':"<?php echo url('admin/admingroup/save'); ?>",
            'type':'post',
            'data':data,
    ...
    function par(obj,id) {
       // alert(id);
        $.get("<?php echo url('admin/adminrule/par'); ?>",{id:id},function (data) {
            alert(data);
        })
    }
