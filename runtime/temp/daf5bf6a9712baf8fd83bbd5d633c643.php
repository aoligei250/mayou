<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\phpStudy\PHPTutorial\WWW\work\public/../application/admin\view\admingroup\edit.html";i:1572275560;s:74:"C:\phpStudy\PHPTutorial\WWW\work\application\admin\view\public\static.html";i:1568445051;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="body-content">
        <form method="post" class="form-x" id="form-x" action="">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="title" value="<?php echo $admingroup['title']; ?>"  />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field">
                  ...
                  <input  <?php  1232131  ?>    type="check"   ></input>
