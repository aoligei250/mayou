<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\wamp64\www\uekblog\public/../application/admin\view\news\index.html";i:1538193321;s:58:"E:\wamp64\www\uekblog\application\admin\view\uekadmin.html";i:1538216881;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>优逸客博客 后台管理系统</title>
	<link rel="shortcut icon" href="/static/admin/img/1.png">
	...
	<div class="container">
		...
		<nav class="navbar navbar-default navbar-primary navbar-fixed-top navbar-blue" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">  <img src="/static/admin/img/logo.png" style="height:100%" alt="">  后台管理系统 </a>
				</div>
		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h2 class="panel-title" id="news"><span class="glyphicon glyphicon-tasks"></span> 新闻管理</h2>
					</div>
					<ul class="list-group">
					    <li class="list-group-item"><a href="<?php echo url('Newtype/index'); ?>">新闻分类列表</a></li> 	
					    <li class="list-group-item"><a href="<?php echo url('News/index'); ?>">新闻列表</a></li> 	
					    <li class="list-group-item"><a href="<?php echo url('Comment/index'); ?>">评论列表</a></li> 	
					</ul>
				</div>
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    ...
					    <li class="list-group-item"><a href="<?php echo url('Slider/index'); ?>">轮播图管理</a></li>
...
<div class="col-md-10">
	...
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo url('news/index'); ?>">新闻管理</a></li>
			...
			<form action="" class="form-inline pull-right">
				<div class="form-group">
					<select name="typeid" id="" class="form-control">
						...
						<?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$types): $mod = ($i % 2 );++$i;if($types['id'] == $typeid): ?>
								<option selected value="<?php echo $types['id']; ?>"><?php echo $types['name']; ?></option>
				...
				<div class="form-group">
					<select name="sort" id="" class="form-control">
						<option value="0" <?php echo $sort==0?'selected':''; ?>>默认</option>
						<option value="1" <?php echo $sort==1?'selected':''; ?>>浏览量</option>
						<option value="2" <?php echo $sort==2?'selected':''; ?>>点赞量</option>
						<option value="3" <?php echo $sort==3?'selected':''; ?>>收藏量</option>
					</select>
				</div>
				<div class="form-group">
		...
		<table class="table-bordered table table-hover">
			...
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
				<tr>
					...
					<td><img width="200px" src="/upload/news/<?php echo $val['img']; ?>" alt=""></td>
					<td><?php echo $val['name']; ?></td>
					<td><?php echo $val['author']; ?></td>
					<td><?php echo $val['num']; ?></td>
					<td><?php echo $val['zannum']; ?></td>
					<td><?php echo $val['shounum']; ?></td>
